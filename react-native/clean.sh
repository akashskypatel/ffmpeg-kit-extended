...
rm -rf \
  ...
  windows/FFmpegKitExtended/obj \
  windows/FFmpegKitExtended/x64 \
  windows/FFmpegKitExtended/x86 \
  windows/FFmpegKitExtended/bin
...
if [[ $# -gt 0 ]] && [[ -n "$1" && "$1" == "full" ]]; then
  echo "Full clean mode enabled. Removing node_modules..."
  rm -rf node_modules
  rm -rf package-lock.json
  rm -rf windows/FFmpegKitExtended/package.lock.json
  rm -rf example/node_modules
  rm -rf example/package-lock.json
  rm -rf example/windows/FFmpegKitExtendedExample/package.lock.json
fi
