...
`TargetPlatform.tester` when running tests. Therefore `flutter test` cannot
make this package's hook select assets for a non-host target. This applies to
