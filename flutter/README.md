...
[Packages](https://github.com/akashskypatel/ffmpeg-kit/wiki/Packages) wiki page to see the names of those
...
[LTS Releases](https://github.com/akashskypatel/ffmpeg-kit/wiki/LTS-Releases) wiki page to see how they differ from each
other.
