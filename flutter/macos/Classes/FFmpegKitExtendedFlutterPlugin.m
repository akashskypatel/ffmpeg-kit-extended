...
static NSString *const kFFmpegKitCompanionAssetsDir =
    @"App.framework/Versions/A/Resources/flutter_assets/packages/ffmpeg_kit_extended_flutter/native";
...
static NSArray<NSString *> *FFmpegKitCompanionDirectoryCandidates(NSBundle *mainBundle) {
  ...
  [directories addObject:[[mainBundle bundlePath]
                             stringByAppendingPathComponent:
                                 @"Contents/Frameworks/App.framework/Versions/A/Resources/flutter_assets/packages/ffmpeg_kit_extended_flutter/native"]];
  return directories;
}
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  NSMutableArray<NSString *> *candidatePaths = [NSMutableArray arrayWithArray:@[
    [[bundle bundlePath] stringByAppendingPathComponent:@"Versions/A/Frameworks/ffmpegkit.framework/Versions/A/ffmpegkit"],
    [[bundle bundlePath] stringByAppendingPathComponent:@"Versions/A/Frameworks/libffmpegkit.dylib"],
    [[bundle bundlePath] stringByAppendingPathComponent:@"Frameworks/ffmpegkit.framework/Versions/A/ffmpegkit"],
    [[bundle bundlePath] stringByAppendingPathComponent:@"Frameworks/libffmpegkit.dylib"],
    [[bundle bundlePath] stringByAppendingPathComponent:@"ffmpegkit.framework/Versions/A/ffmpegkit"],
    [[bundle bundlePath] stringByAppendingPathComponent:@"libffmpegkit.dylib"],
    // Native assets location on macOS
    [[mainBundle bundlePath] stringByAppendingPathComponent:@"Contents/Frameworks/ffmpegkit.framework/Versions/A/ffmpegkit"],
