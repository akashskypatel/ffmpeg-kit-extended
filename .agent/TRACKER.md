...
- **Transition:** N9 is completed by user acceptance. FFK24-N10 is closed by user acceptance as out of scope. N11 is complete with its runtime mismatch documented below; N12 was later completed with the native/Wasm evidence below. Publication/browser closeout remains in later gates.
...
- **Transition:** FFK24-N12 is complete with the sole TSan exception inherited from the user-accepted N10 disposition. R24-G68 remains partial; G69–G71 remain the outstanding publication and consumer-validation goals. No sanitizer suppression, fixture weakening, or product source workaround was added.
...
N7–N11 have explicit dispositions. FFK24-N12 is complete with the native and Wasm evidence recorded above; G68–G71 remain outstanding in the subsequent order.
