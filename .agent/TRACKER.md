...
- The frozen builder source remains `625c3452ee3c93fb5d701bb6546726940b88d014`; its source snapshot is [builder workflow run 35932349418](https://github.com/akashskypatel/ffmpeg-kit-builders/actions/runs/35932349418), artifact `review24-builders-source-35932349418`, artifact ID `10781566959`; [download the builder source snapshot](https://api.github.com/repos/akashskypatel/ffmpeg-kit-builders/actions/artifacts/10781566959/zip). The builder checkout and prebuilt archives were not modified or published.
...
- The unchanged frozen builder source was separately source-snapshotted at `625c3452ee3c93fb5d701bb6546726940b88d014`: [builder snapshot workflow run 35932349418](https://github.com/akashskypatel/ffmpeg-kit-builders/actions/runs/35932349418), artifact `review24-builders-source-35932349418`, artifact ID `10781566959`; [download the builder source snapshot](https://api.github.com/repos/akashskypatel/ffmpeg-kit-builders/actions/artifacts/10781566959/zip). No builder checkout or native ABI binary was modified or published.
...
- The frozen builder source was independently snapshotted by [builder workflow run 35932349418](https://github.com/akashskypatel/ffmpeg-kit-builders/actions/runs/35932349418). Its checkout log verifies `snapshot_sha=625c3452ee3c93fb5d701bb6546726940b88d014`; the successful source artifact is `review24-builders-source-35932349418`, artifact ID `10781566959`; [download the builder source snapshot artifact](https://api.github.com/repos/akashskypatel/ffmpeg-kit-builders/actions/artifacts/10781566959/zip). The separate log artifact is `10781831131`.
